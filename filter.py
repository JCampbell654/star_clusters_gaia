...
data_folder = 'C:/Users/rhbjo/OneDrive - The University of Nottingham/Shared/Data/'
data = Data(data_folder + 'messier 41.json')
...
filtered_data, probability = filter_data(data, 710, 3.92, plot=False)
...
plt.hist(np.clip(1/(data.parallax * 1e-3), 0, 2000), bins=100)
